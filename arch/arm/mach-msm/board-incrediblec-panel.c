...
static uint32_t sony_tft_display_on_gpio_table[] = {
	LCM_GPIO_CFG(INCREDIBLEC_SPI_CLK, 1, GPIO_4MA),
	LCM_GPIO_CFG(INCREDIBLEC_SPI_CS, 1, GPIO_4MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_ID0, 1, GPIO_4MA),
	LCM_GPIO_CFG(INCREDIBLEC_SPI_DO, 1, GPIO_4MA),	
};

static uint32_t sony_tft_display_off_gpio_table[] = {
	LCM_GPIO_CFG(INCREDIBLEC_SPI_CLK, 0, GPIO_4MA),
	LCM_GPIO_CFG(INCREDIBLEC_SPI_CS, 0, GPIO_4MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_ID0, 0, GPIO_4MA),
	LCM_GPIO_CFG(INCREDIBLEC_SPI_DO, 0, GPIO_4MA),
