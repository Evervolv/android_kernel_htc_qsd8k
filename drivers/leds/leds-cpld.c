...
static void led_brightness_set2(struct led_classdev *led_cdev,
...
static int CPLD_LED_probe(struct platform_device *pdev)
{
	...
	CPLD_LED->leds[0].brightness_set = led_brightness_set2;

	CPLD_LED->leds[1].name = "green";
	CPLD_LED->leds[1].brightness_set = led_brightness_set2;

	CPLD_LED->leds[2].name = "blue";
	CPLD_LED->leds[2].brightness_set = led_brightness_set2;

	CPLD_LED->leds[3].name = "jogball-backlight";
	CPLD_LED->leds[3].brightness_set = led_brightness_set2;
